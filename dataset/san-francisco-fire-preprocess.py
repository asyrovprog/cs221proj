...
if __name__ == "__main__":
    FROMFILE = "../data_raw/san-francisco-fire.csv"
    TOFILE = "../ds/san-francisco-fire-counts-2001-2017.csv"
    ...
    TOFILE = "../ds/san-francisco-fire-counts-2001-2017-hours.csv"
    print("Creating by day totals for incidents...")
    # preprocess(FROMFILE, TOFILE, 'Received DtTm', start_date, end_date, False)
    print("Saved to " + TOFILE)

    TOFILE = "../ds/san-francisco-fire-counts-2001-2017-hours-gaussian.csv"
    print("Creating by day totals for incidents...")
